...
-- ----------------------------
BEGIN;
INSERT INTO `sys_job` VALUES (1, '欢迎来到crown', 'org.crown.project.monitor.quartz.task.SystemOutWelcomeTask', '{}', '0 0/5 * * * ?', b'0', '欢迎来到crown', '2019-07-25 11:28:16', '2019-05-29 15:40:41', 0, 'crown', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_post` VALUES (1, 'ceo', '董事长', 1, '0', 'crown', '2018-03-16 11:33:00', 'crown', '2018-03-16 11:33:00', '');
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', '0', '0', 'crown', '2018-03-16 11:33:00', 'crown', '2019-06-21 17:16:42', '普通角色');
COMMIT;
