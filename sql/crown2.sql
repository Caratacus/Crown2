...
-- ----------------------------
BEGIN;
INSERT INTO `sys_config` VALUES ('1', '主框架页-默认皮肤样式名称', 'sys.index.skinName', 'skin-purple', 'Y', 'admin', '2018-03-16 11:33:00', null, '2019-07-03 14:16:38', '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow'), ('2', '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 'Y', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '初始化密码 123456');
COMMIT;
...
CREATE TABLE `sys_job` (
  ...
  `job_params` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '参数',
  `cron` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT 'cron表达式',
  `paused` bit(1) NOT NULL COMMENT '是否启动',
  `description` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '备注',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_job` VALUES ('1', '欢迎来到Crown', 'org.crown.project.monitor.quartz.task.SystemOutWelcomeTask', '', '0 */1 * * * ?', b'0', '定时删除过期订单', '2019-07-10 15:59:27', '2019-05-29 15:40:41', '0', 'crown', 'crown');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES ('1', '管理员', 'admin', '1', '1', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '管理员'), ('2', '普通角色', 'common', '2', '2', '0', '0', 'admin', '2018-03-16 11:33:00', null, '2019-06-21 17:16:42', '普通角色');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_online` VALUES ('9dc49abe-7ebf-4a01-abd2-f16d80002881', 'admin', '研发部门', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome', 'Mac OS X', 'on_line', '2019-07-10 18:44:18', '2019-07-10 18:45:43', '1800000');
COMMIT;
